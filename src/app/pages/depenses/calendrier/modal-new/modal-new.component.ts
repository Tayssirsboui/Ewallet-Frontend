...
import { ModalConfigg } from './modal.config';
...
export class ModalNewComponent implements OnInit {
  ...
  @Input() public modalConfig!: ModalConfigg;

  @Input() item: any;
  private modalContent!: TemplateRef<ModalNewComponent>;
  ...
  get f() {
    return this.nouvelledepenseForm.controls;
  }
