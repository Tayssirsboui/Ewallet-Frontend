...
import { ChangeEventArgs, DropDownListComponent, MultiSelectChangeEventArgs, MultiSelectComponent } from '@syncfusion/ej2-angular-dropdowns';
...
import { AgendaService, CellClickEventArgs, DayService, EventSettingsModel, ExcelExportService, GroupModel, ICalendarExportService, MonthService, PrintService, ResourcesModel, ScheduleComponent, TimelineMonthService, TimelineViewsService, TimelineYearService, Timezone, View, WeekService, WorkWeekService, YearService } from '@syncfusion/ej2-angular-schedule';
...
@Component({
  ...
  template: `./syncfusion-scheduler.component.html`,
...
export class SyncfusionSchedulerComponent implements OnInit {
  ...
  //       url: 'https://your-api-url.com/events', // Remplacez par votre URL d'API pour récupérer les événements
